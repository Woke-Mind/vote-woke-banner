...
function setup() {
  ...
  my.qrcode_url = () => {
    // return `./qrcode/qrcode_heathercoxrichardson.substack.com.png?v=61`;
    return `./qrcode/qrcode.png?v=61`;
  };
  my.showQRCode = () => {
...
// https://molab-itp.github.io/p5moLibrary/src/demo/mo-gallery-1/?v=61

// https://editor.p5js.org/jht9629-nyu/sketches/VtqUmOlGB

// https://heathercoxrichardson.substack.com/p/october-26-2024

// https://molab-itp.github.io/moSalon/src/vote-no-fascism/?v=61
